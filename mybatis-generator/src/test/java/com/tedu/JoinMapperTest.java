...
import examples.joins.OrderDetail;
import examples.joins.OrderMaster;
import examples.joins.User;
...
import static examples.joins.UserDynamicSQLSupport.user1;
import static examples.joins.UserDynamicSQLSupport.user2;
...
//        try (Connection connection = DriverManager.getConnection(JDBC_URL, "root", "root")) {
//            ScriptRunner sr = new ScriptRunner(connection);
//            sr.setLogWriter(null);
//            sr.runScript(new InputStreamReader(is));
//        }
        
        UnpooledDataSource ds = new UnpooledDataSource(JDBC_DRIVER, JDBC_URL, "root", "root");
